...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1615, 1479))
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 2365, 34))
        ...
        icon = QtGui.QIcon.fromTheme("save.png")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.saveProj.setStatusTip(_translate("MainWindow", "Save the labels to a file"))
        self.saveProj.setWhatsThis(_translate("MainWindow", "Save the labels to a file"))
